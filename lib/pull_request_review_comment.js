...
/**
 * Webhook request information for `pull_request_review_comment`.
 * @see https://developer.github.com/v3/activity/events/types/
 * @module github-webhook-fixtures:pull_request_review_comment
 */
module.exports = buildWebhookFixture('pull_request_review_comment', {
  "action": "created",
  "comment": {
