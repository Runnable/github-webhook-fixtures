...
var buildWebhookFixture = require('./build-webhook-fixture');

/**
 * Webhook request information for `membership`.
 * @see https://developer.github.com/v3/activity/events/types/
 * @module github-webhook-fixtures:membership
 */
module.exports = buildWebhookFixture('membership', {
  "action": "added",
  "scope": "team",
  "member": {
    "login": "kdaigle",
